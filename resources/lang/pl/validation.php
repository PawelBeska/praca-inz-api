...
return [
    ...
    */
    ...
    'exists' => 'Podany :attribute jest nieprawidłowy',
    ...
    'bank_account_number' => "Podany numer konta bankowego jest nieprawidłowy",
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    'attributes' => [
        ...
        'residence_country' => 'kraj zamieszkania',
        'residence_city' => 'miasto zamieszkania',
        'residence_postal_code' => 'kod pocztowy',
        'residence_street' => 'ulica',
        'residence_building_number' => 'numer budynku',
        'residence_apartment_number' => 'numer mieszkania',
        'correspondence_country' => 'kraj',
        'correspondence_city' => 'miasto',
        'correspondence_postal_code' => 'kod pocztowy',
        'correspondence_street' => 'ulica',
        'correspondence_building_number' => 'numer budynku',
        'correspondence_apartment_number' => 'numer mieszkania',
        'password' => 'hasło',
        'new_password' => 'nowe hasło',
        'account_number' => 'number konta bankowego',
        'interest_rate' => 'oprocentowanie',
        'put_option' => 'opcja put',
        'call_option' => 'opcja call',
        'share_capital' => 'kapitał zakładowy',
        'surcharge_amount' => 'kapitał dopłaty',
        'published' => 'opublikowany',
        //NEW
        'tax_office_address' => 'dane urzedu skarbowego',
        'company_krs' => "Numer krs",
        'company_regon' => "Numer regon",
        'company_nip' => "Numer NIP",
        ''
    ],
];
